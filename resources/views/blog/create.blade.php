...
@section('style')
    <style>
        /* تنسيق منطقة الرفع لتشبه الصورة */
        .border-dashed {
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card border-0 shadow-lg w-100 p-4">
                    <h2 class="fw-bold mb-1">Create Post Form</h2>
                    <p class="text-muted mb-4">Please fill out the form below To publish your post.</p>
                    ...
                    <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <p class="small text-muted mb-2">Upload any images for design reference</p>
                            ...
                            <div class="upload-area border border-2 border-dashed rounded-3 p-5 text-center bg-light">
                                ...
                                <label for="image_path" style="cursor: pointer;" id="upload-label">
                                    <div id="file-info">
                                        <span class="text-primary fw-bold">Choose file</span>
